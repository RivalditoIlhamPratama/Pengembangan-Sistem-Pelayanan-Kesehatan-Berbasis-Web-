...
Route::middleware(['auth'])->group(function () {
    Route::get('/konsultasi/{dokterId}', [KonsultasiController::class, 'index'])->name('konsultasi.index');
...
Route::middleware(['auth'])->prefix('dokter')->group(function () {
    Route::get('/konsultasi', [KonsultasiController::class, 'dataKonsultasi'])->name('dokter.konsultasi');
    Route::get('/chat/{pasienId}', [KonsultasiController::class, 'chatPasien'])->name('dokter.chat');
});

Route::middleware(['auth'])->prefix('dokter')->group(function () {
    
    Route::get('/chat/{pasienId}', [KonsultasiController::class, 'chatPasien'])->name('dokter.chat');
    Route::post('/dokter/kirim', [KonsultasiController::class, 'kirim'])->name('dokter.kirim');
});
