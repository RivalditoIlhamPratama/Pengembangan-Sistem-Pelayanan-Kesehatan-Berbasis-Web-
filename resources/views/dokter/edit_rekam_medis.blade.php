                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input name="usiaPasien" id="editUsiaPasien" type="number" class="form-control text-left" placeholder="usiaPasien" step="1" required >
                        </div>
                    </div>
                    <div class="mb-3">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.querySelectorAll(".btn-warning").forEach(button => {
        button.addEventListener("click", function(event) {
            ...
            const statusNikahOptions = ["Belum Kawin", "Kawin Tercatat", "Kawin Belum Tercatat", "Cerai Hidup", "Cerai Mati"];
