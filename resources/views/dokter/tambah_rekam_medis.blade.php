            ...
            <form action="{{ route('dokter.rekam_medis.submit') }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <input name="usiaPasien" id="usiaPasienInput" type="number" class="form-control text-center"
                                placeholder="Usia Pasien" step="1" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row mb-3">
                    <div class="col-md-2">
                        ...
                        <div class="input-group">
                            <input name="suhu" id="suhuInput" type="number" class="form-control text-center"
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="input-group">
                            <input name="tinggiBadan" id="tinggiBadan" type="number" class="form-control text-center"
                                placeholder="Tinggi Badan" min="0" step="1" required>
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="input-group">
                            <input name="beratBadan" id="beratBadan" type="number" class="form-control text-center"
                                placeholder="Berat Badan" min="0" step="1" required>
                        </div>
                    </div>
                </div>
