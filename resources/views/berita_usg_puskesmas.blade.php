...
<header class="header mt-0">
  <nav class="mt-0">
    ...
    <ul class="nav__links" id="nav-links">
      ...
      <li class="link"><a href="{{ url('/') }}">Pelayanan</a></li>
      @endif
...
<section class="news-section">
  <article class="main-content">
    ...
    <p><strong>Kraksaan, Probolinggo —</strong> Pelayanan ibu hamil di Puskesmas Kraksaan semakin maksimal. Pasalnya, Puskesmas Kraksaan kini dilengkapi layanan USG (Ultrasonografi) yang diberikan secara gratis. Layanan ini tersedia dua kali dalam seminggu, setiap hari Senin dan Kamis.</p>
    
    <p>Kepala Puskesmas Kraksaan, <strong>dr. Heni Rahmawati</strong>, menjelaskan bahwa bagi ibu hamil, selain mendapatkan pelayanan ANCT (Antenatal Care Terpadu), kini juga dapat menikmati pemeriksaan USG. Alur pelayanan dimulai dari pendaftaran di loket, pemeriksaan di ruang KIA, kemudian dilanjutkan pemeriksaan laboratorium untuk pengecekan HB, sifilis, HIV, dan lainnya.</p>
    
    <p>“Pasien dicek HB, sipilis, HIV, semuanya seperti biasanya. Setelah itu pasien kembali ke KIA dan langsung saya lakukan USG sambil memeriksa hasil laboratorium. Kemudian pasien diarahkan ke poli gizi, poli gigi, lalu pengambilan obat, dan bisa pulang,” terang dr. Heni.</p>
    
    <p>dr. Heni menambahkan bahwa layanan ANCT merupakan pemeriksaan terpadu yang melibatkan pemeriksaan dari bidang, laboratorium, gizi, gigi, hingga dokter. Semua layanan ANCT dan USG diberikan tanpa biaya kepada pasien. Total terdapat 18 desa yang menjadi sasaran layanan ini, dibagi 9 desa setiap Senin dan 9 desa setiap Kamis untuk menghindari kerumunan.</p>
    
    <p>“Terkadang dalam sehari, ANCT bisa mencapai 40 pasien, tetapi tidak semuanya perlu USG. USG diwajibkan pada kehamilan trimester satu dan tiga, sedangkan trimester dua tidak wajib kecuali ada indikasi medis tertentu,” jelasnya.</p>
    
    <p>Selain itu, bagi ibu hamil dengan usia kandungan kurang dari 12 minggu, juga diberikan tambahan susu sebagai nutrisi awal. “Susu diberikan untuk kontak pertama (K1) yang usia kehamilannya di bawah 12 minggu,” tambah dr. Heni.</p>
  </article>
