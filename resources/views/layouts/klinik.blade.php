        ...
        <aside id="sidebar"
            ...
            <nav class="mt-4 flex flex-col gap-2 px-4">
                <a href="{{ route('klinik.dashboard') }}"
                    class="py-2 px-4 rounded hover:bg-gray-800 {{ request()->routeIs('klinik.dashboard') ? 'bg-gray-800' : '' }}">
                    <i class="ri-dashboard-line mr-2"></i> Dashboard
                </a>
                <a href="{{ route('klinik.laporan') }}"
                    class="py-2 px-4 rounded hover:bg-gray-800 {{ request()->routeIs('klinik.laporan') ? 'bg-gray-800' : '' }}">
