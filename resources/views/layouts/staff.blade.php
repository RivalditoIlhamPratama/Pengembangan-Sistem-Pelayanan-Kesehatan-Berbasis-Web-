...
<body class="bg-gray-100">
    ...
    <nav class="mt-4 flex flex-col gap-2 px-4 relative z-10">
        <a href="{{ route('staff.data_staffrm') }}"
           class="py-2 px-4 rounded hover:bg-blue-50 transition-all duration-150 flex items-center gap-2 font-medium {{ request()->routeIs('staff.data_staffrm') ? 'bg-blue-100 text-blue-700 font-semibold' : '' }}">
            <i class="ri-user-line"></i>
            <span>Profil</span>
        </a>
        <a href="{{ route('stafrekammedis.dashboard') }}"
           class="py-2 px-4 rounded hover:bg-blue-50 transition-all duration-150 flex items-center gap-2 font-medium {{ request()->routeIs('stafrekammedis.dashboard') ? 'bg-blue-100 text-blue-700 font-semibold' : '' }}">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="flex justify-between items-center p-4 bg-white border-b">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <a href="{{ route('staff.data_staffrm') }}" class="text-black hover:underline hover:text-blue-600">
                        {{ $staff->namaStaff }}
                    </a>
