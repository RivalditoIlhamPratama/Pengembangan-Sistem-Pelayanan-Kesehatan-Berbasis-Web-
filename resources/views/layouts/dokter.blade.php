...
<body class="bg-gray-100">
    ...
    <div class="flex h-screen">
        ...
        <aside id="sidebar"
            ...
            <!-- Logo -->
            <div class="p-5 flex items-center space-x-3 border-b border-gray-700 relative z-10">
            ...
            <nav class="mt-4 flex flex-col gap-2 px-4 relative z-10">
                <a href="{{ route('dokter.dashboard') }}"
                    class="py-2 px-4 rounded hover:bg-gray-800 {{ request()->routeIs('dokter.dashboard') ? 'bg-gray-800' : '' }}">
                    <i class="ri-dashboard-line mr-2"></i> Dashboard
                </a>
                <a href="{{ route('dokter.data_dokter') }}"
                    class="py-2 px-4 rounded hover:bg-gray-800 {{ request()->routeIs('dokter.data_dokter') ? 'bg-gray-800' : '' }}">
                    <i class="ri-user-3-line mr-2"></i> Data Dokter
                </a>
                <a href="{{ route('dokter.rekam_medis') }}"
                    class="py-2 px-4 rounded hover:bg-gray-800 {{ request()->routeIs('dokter.rekam_medis') ? 'bg-gray-800' : '' }}">
