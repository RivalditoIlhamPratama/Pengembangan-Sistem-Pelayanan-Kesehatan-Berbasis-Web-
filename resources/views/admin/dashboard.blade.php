...
@section('content')
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <!-- Card Total Pengguna -->
            <div
                class="bg-gradient-to-r from-blue-100 to-white shadow-md hover:shadow-xl transition-all duration-500 rounded-2xl p-6 border-l-8 border-blue-600 flex items-center">
            ...
            <!-- Card Total Dokter -->
            <div
                class="bg-gradient-to-r from-green-100 to-white shadow-md hover:shadow-xl transition-all duration-500 rounded-2xl p-6 border-l-8 border-green-600 flex items-center">
            ...
            <div
                class="bg-gradient-to-r from-red-100 to-white shadow-md hover:shadow-xl transition-all duration-500 rounded-2xl p-6 border-l-8 border-red-600 flex items-center">
