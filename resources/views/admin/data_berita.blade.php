                ...
                <tbody>
                    @foreach ($berita as $b)
                        <tr>
                            ...
                            <td>
                                @if ($b->gambarBerita)
                                    <img src="{{ asset('storage/' . $b->gambarBerita) }}" width="80"
                                        class="img-thumbnail">
                                @else
                            ...
                            <td class="text-center">
                                <div class="btn-group" role="group">
                                    ...
                                    <!-- Modal Edit -->
                                    <div class="modal fade" id="editModal{{ $b->idBerita }}" tabindex="-1"
                                        aria-labelledby="editModalLabel{{ $b->idBerita }}" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <form action="{{ route('admin.berita.update', $b->idBerita) }}"
                                                    method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="editModalLabel{{ $b->idBerita }}">Edit
                                                            Berita</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="date" class="form-control" name="tanggalBerita"
                                                                value="{{ $b->tanggalBerita }}" required>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="form-label">Judul Berita</label>
                                                            <input type="text" class="form-control" name="judulBerita"
                                                                value="{{ $b->judulBerita }}" required>
                                                        </div>
                                                        <div class="mb-3">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="file" class="form-control"
                                                                name="gambarBerita">
                                                            @if ($b->gambarBerita)
                                                                <img src="{{ asset('storage/' . $b->gambarBerita) }}"
                                    ...
                                    <!-- Tombol Hapus -->
                                    <form action="{{ route('admin.berita.destroy', $b->idBerita) }}" method="POST"
