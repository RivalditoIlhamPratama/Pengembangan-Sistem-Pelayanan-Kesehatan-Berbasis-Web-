    ...
    <div class="card p-4 shadow-sm">
        ...
        <form action="{{ route('admin.data_dokter.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="namaDokter" id="namaDokter" placeholder="Masukkan nama dokter">
            </div>

            <div class="mb-3">
                <label for="spesialis" class="form-label">Spesialis</label>
                <input type="text" class="form-control" name="spesialis" id="spesialis" placeholder="Contoh: Umum, Gigi, Anak, dll">
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="alamatDokter" name="alamatDokter" rows="2" placeholder="Masukkan alamat lengkap"></textarea>
            </div>

            <div class="mb-3">
                <label for="noTelepon" class="form-label">No Telepon</label>
                <input type="text" class="form-control" name="noTelepon" id="noTelepon" placeholder="Contoh: 081234567890">
            </div>
